import Vue from 'vue'
        ...
        import HotelsIndex from '../components/cruds/Hotels/Index.vue'
        import HotelsCreate from '../components/cruds/Hotels/Create.vue'
        import HotelsShow from '../components/cruds/Hotels/Show.vue'
        import HotelsEdit from '../components/cruds/Hotels/Edit.vue'
...
const routes = [
    ...
    {path: '/hotels', component: CompaniesIndex, name: 'hotels.index'},
    {path: '/hotels/create', component: CompaniesCreate, name: 'hotels.create'},
    {path: '/hotels/:id', component: CompaniesShow, name: 'hotels.show'},
    {path: '/hotels/:id/edit', component: CompaniesEdit, name: 'hotels.edit'},
]
